    ...
    snapshot.forEach(function(childSnapshot){
      ...
      if (childKey != "purpose") {
          ...
          if (imageURL=="") {
            ...
            console.log("imageURL=empty");
            document.getElementById("chat").innerHTML=document.getElementById("chat").innerHTML+'<h3 id="inf"> Username- '+users+'</h3><img style="width:50%" src="'+imageURL+'"><h3 id="inf">Message- '+message+'</h3><button class="btn btn-success" id="'+messageID+'" onclick="likes(this.id)" value="'+like+'">Like: '+like+'</button><hr>';
          }       
        }
  });
});
